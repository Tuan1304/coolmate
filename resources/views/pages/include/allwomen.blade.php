...
<section class="category">
    <div class="container" >
        <div class="category-top">
            <p>Trang chủ</p><span>&#47;</span><p>Thời trang nữ</p>
        </div>
    </div>
    <div class="container">
        <div class="category-top-img">
            <img src="{{asset('imgs/spnu.jpg')}}" alt="">
        </div>
    </div>
    <div class="container">
        <div class="all-brand">
            @foreach ($women as $key => $women)
                <div class="category-brand-item">
                    <a href="{{route('women',$women->slug)}}"><img src="{{asset('uploads/women/'.$women->image)}}" alt=""></a>
                    <a href="{{route('women',$women->slug)}}"><p>{{$women->title}}</p></a>
                </div>
            @endforeach
        </div>
    </div>
