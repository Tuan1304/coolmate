        ...
        <div class="all-brand">
            @foreach ($children as $key => $child)
                <div class="category-brand-item">
                    <a href="{{route('children',$child->slug)}}"><img style="max-height:100px; max-width:100px" src="{{asset('uploads/children/'.$child->image)}}" alt=""></a>
                    <a href="{{route('children',$child->slug)}}"><p>{{$child->title}}</p></a>
                </div>
            @endforeach
        </div>
    </div>
