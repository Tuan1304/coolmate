...
<section class="category">
    <div class="container" >
        <div class="category-top">
            <p>Trang chủ</p><span>&#47;</span><p>{{$coll_slug->title}}</p>
        </div>
    </div>
    <div class="container">
        <div class="category-top-img">
            <img src="{{asset('uploads/collection/banner/'.$coll_slug->banner)}}" alt="">
        </div>
    </div>
    {{-- <div class="container">
        <div class="all-brand">
            @foreach ($man as $key => $men)
                <div class="category-brand-item">
                    <a href="{{route('man',$men->slug)}}"><img src="{{asset('uploads/man/'.$men->image)}}" alt=""></a>
                    <a href="{{route('man',$men->slug)}}"><p>{{$men->title}}</p></a>
                </div>
            @endforeach
        </div>
    </div> --}}
        ...
        <div class="row-flex">
            <div class="category-right-top">
                <div class="category-right-top row-flex">
                    ...
                    <form action="{{route('collection',$coll_slug->slug)}}" method="GET">
                        @csrf
                ...
                <div class="category-right-top-content ">
                    <div class="row-grid row-grid-hot-products">
                        ...
                        <div class="hot-product-item">
                            ...
                            <a href="" class="test-anh"><img src="{{asset('uploads/collection/icon/'.$coll_slug->icon)}}"></a>
